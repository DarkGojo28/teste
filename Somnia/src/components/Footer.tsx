...
export const Footer = () => {
  return (
    <footer id="footer" className="py-20 bg-slate-950 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-xl tracking-tight text-white">SOMNIA</span>
          </div>
          
          <div className="flex flex-wrap justify-center gap-8 text-sm font-bold uppercase tracking-widest text-slate-500">
        ...
        <div className="pt-12 border-t border-white/5 text-center">
          <p className="text-[10px] md:text-xs text-slate-500 leading-relaxed max-w-4xl mx-auto uppercase tracking-widest font-medium">
